...
<div id="smartwizard-2" class="border-bottom smartwizard-example sw-main sw-theme-default mt-2">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item active"> <a href="<?= site_url('erp/create-order');?>" class="mb-3 nav-link"> <span class="sw-done-icon feather icon-check-circle"></span> <span class="sw-icon fas fa-calendar-plus"></span>
  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body" aria-expanded="true" style="">
        <div class="row m-b-1">
          <div class="col-md-12">
            <?php $attributes = array('name' => 'new_order', 'id' => 'xin-form', 'autocomplete' => 'off', 'class' => 'form');?>
            <?php $hidden = array('user_id' => 0);?>
            <?php echo form_open('erp/orders/create_new_order', $attributes, $hidden);?>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input class="form-control" placeholder="<?= lang('Inventory.xin_order_number');?>" name="order_number" type="text" value="<?= $inv_info;?>">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
