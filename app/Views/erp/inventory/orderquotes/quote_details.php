      ...
      <div>
        <div class="card" id="printTable">
          <div class="card-header">
            <h5>
              <?= lang('Inventory.xin_view_quote').' #'.$result['quote_number'];?>
            </h5>
            <div class="card-header-right"> <a href="<?= site_url('erp/print-quote/').$segment_id;?>" target="_blank" class="collapsed btn btn-sm waves-effect waves-light btn-success m-0">
              ...
              <?php if($user_info['user_type'] != 'customer'){ ?>
				  <?php if($result['status'] == 0) { ?>
                      ...
                      <a href="<?= site_url('erp/edit-quote/').$segment_id;?>" class="collapsed btn btn-sm waves-effect waves-light btn-primary m-0">
                      <?= lang('Main.xin_edit');?>
                      </a>
                      <?php } ?>
                  <?php } ?>
