...
$invoice_report = purchases_report($start_date,$end_date,$status);
        ...
        <div class="card" id="printTable">
          ...
          <div class="card-body pb-0">
            <div class="row invoive-info d-pdrint-inline-flex ">
              <div class="col-md-8">
                    <h6 class="text-primary"><?= lang('Inventory.xin_purchases_report');?> :</h6>
                  ...
                  <table class="table m-b-0 f-14 b-solid requid-table">
                    <thead>
                      <tr class="text-uppercase">
                        <th><?= lang('Inventory.xin_supplier');?></th>
                        <th><?= lang('Inventory.xin_purchase_number');?></th>
                    ...
                    <tbody>
                      ...
                      <?php $_supplier = $SuppliersModel->where('supplier_id', $_invoice->supplier_id)->first();?>
                      <?php
					    if($_supplier){
                      ...
                      <tr>
                        ...
                        <td width="200"><?= number_to_currency($_invoice->grand_total,$xin_system['default_currency'],null,0);?></td>
